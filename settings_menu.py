...
FILE_LOCATIONS = [
  ...
  {TEXT: "txtTerminology",  BTN: "btnTerminology",  CFG: "terminology",   FN: get_open_file,    FILTER: "TerminologyDR2.csv (*.csv)"},
  {TEXT: "txtDupes",        BTN: "btnDupes",        CFG: "dupes_csv",     FN: get_open_file,    FILTER: "dupesDR2STEAM.csv (*.csv)"},
  # {TEXT: "txtEbootText",    BTN: "btnEbootText",    CFG: "eboot_text",    FN: get_open_file,    FILTER: "eboot_text.csv (*.csv)"},
  {TEXT: "txtSimilarity",   BTN: "btnSimilarity",   CFG: "similarity_db", FN: get_open_file,    FILTER: "similarity-dbDR2.sql (*.sql)"},
