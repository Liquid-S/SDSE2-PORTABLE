...
DEFAULT_SETTINGS = {
  ...
  "data00_dir":         "./WORK/data00",
  "data01_dir":         "./WORK/SHARE_THIS/data01",
  "dupes_csv":          "./WORK/SHARE_THIS/dupesDR2STEAM.csv",
  # "eboot_orig":         "./WORK/EBOOT-ORIG.BIN",
  # "eboot_text":         "./WORK/data/eboot_text.csv",
  "gfx_dir":            "./WORK/!editor/gfx",
  "highlight_tags":     True,
  "highlight_terms":    True,
  "iso_dir":            "./WORK/!ISO_EDITED",
  "iso_file":           "./WORK/SDR2_EDITED.iso",
  "lang_orig":          "ja",
  "lang_trans":         "en",
  "last_checked_with":  "./WORK/data01-orig",
  "last_exported":      "./WORK/data01",
  "last_export_target": "./WORK/data01-ex",
  "last_font":          "./WORK/debug/test.sdse-font",
  "last_imported":      "./WORK/!changes",
  "last_import_target": "./WORK/!imported",
  "last_opened":        "e00_001_180.lin",
  "log_level":          "Info",
  "mangle_text":        True,
  "pack_data00":        False,
  "pack_data01":        True,
  "quick_build":        False,
  "quick_clt":          True,
  "similarity_db":      "./WORK/SHARE_THIS/similarity-dbDR2.sql",
  "similarity_thresh":  50.0,
  "smart_quotes":       False,
  "spell_check":        True,
  "spell_check_lang":   "en_US",
  "terminology":        "./WORK/SHARE_THIS/Terminology.csv",
  "text_repl":          True,
